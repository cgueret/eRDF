...
public class Test implements Observer {
	...
	public Test() throws FileNotFoundException, IOException {
		...
		artistStmt.setPredicateVar(new Var("bp1", new URIImpl("http://www.w3.org/1999/02/22-rdf-syntax-ns#type")));
		artistStmt.setObjectVar(new Var("bp2", new URIImpl("http://dbpedia.org/ontology/Artist")));
